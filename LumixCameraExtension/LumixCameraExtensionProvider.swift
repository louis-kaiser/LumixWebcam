//
//  LumixCameraExtensionProvider.swift
...
class LumixCameraExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: LumixCameraExtensionStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = LumixCameraExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class LumixCameraExtensionStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? LumixCameraExtensionDeviceSource else {
...
class LumixCameraExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: LumixCameraExtensionDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = LumixCameraExtensionDeviceSource(localizedName: "SampleCapture (Swift)")
