...
#ifndef LUMIXWEBCAM_SWIFT_H
#define LUMIXWEBCAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LumixWebcam",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC11LumixWebcam18CapturePreviewView")
...
SWIFT_CLASS("_TtC11LumixWebcam16ExtensionManager")
...
@interface ExtensionManager (SWIFT_EXTENSION(LumixWebcam)) <OSSystemExtensionRequestDelegate>
